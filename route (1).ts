  ...
  const refinePrompt = useCallback(async (instruction: string, isVoice = false) => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
          model: isVoice ? 'gemini-3.1-flash-live-preview' : (modelType !== 'ultra-fast' ? 'gemini-3-flash-preview' : 'gemini-3.1-flash-lite'),
          contents: [
  ...
  return (
    <div className="h-screen w-full flex flex-col overflow-hidden bg-[#070707] text-white font-sans selection:bg-zinc-800 relative">
      ...
      {view === 'home' ? (
        ...
        <div className={`mx-auto flex min-h-screen w-full gap-4 px-6 pb-24 pt-10 ${agentMaxPreviewOpen ? 'max-w-7xl' : 'max-w-4xl flex-col'}`}>
          <section className={`${agentMaxPreviewOpen ? 'w-[52%]' : 'w-full'} flex flex-col gap-5`}>
            <div className="mx-auto w-full max-w-2xl rounded-[22px] bg-[#141414] p-2">
              <div className="flex items-center gap-3 rounded-[18px] bg-[#0f0f0f] px-4 py-3">
                ...
                <input
                  ...
                  placeholder="Ask Agent Max to edit, add, rewrite, or generate another file..."
            ...
            <div className="rounded-[28px] bg-[#101010] p-7">
              <div className="mb-6 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-zinc-500">Research, files, docs, prompts, skills, and edits in one workspace.</p>
                </div>
                <div className="flex items-center gap-2">
                  <button
